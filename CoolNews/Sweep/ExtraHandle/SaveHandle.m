...
- (NSArray <__kindof SweepUserModel *> *)findModelWithDifficulty:(KindOfUserDifficulty)difficulty {
    ...
    while ([set next]) {
        ...
        [array addObject:[SweepUserModel modelWithName:name Time:time ID:id_vierfy Difficulty:difficulty RandomNum:randomNum]];
    }
